...
SUPPORTED_COMBINATIONS = [
    ...
    {"debug": "y"},
    {"debug": "n"},
    {"use_activecollab_digger": "y"},
    {"use_activecollab_digger": "n"},
    {"use_elasticsearch": "y"},
    {"use_elasticsearch": "n"},
    {"use_ldap_authentication": "y"},
    {"use_ldap_authentication": "n"},
    {"use_wagtail": "y"},
    {"use_wagtail": "n"},
    {"use_wagtail_search": "y"},
...
@pytest.mark.parametrize(
    ...
    [
        ("n", "pytest"),
        ("y", "docker-compose -f local.yml run django coverage run -m pytest"),
    ],
)
